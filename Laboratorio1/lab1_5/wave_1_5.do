...
add wave -noupdate -expand -group c_out_half_adder -format Logic /testcount/ucounter1/hadder1__1/hai/co
...
add wave -noupdate -expand -group s_half_adder -format Logic /testcount/ucounter1/hadder1__1/hai/s
...
WaveRestoreCursors {{Cursor 1} {516000 ps} 0}
...
update
WaveRestoreZoom {514100 ps} {517800 ps}
